...
type GreetResponse struct {
	...
	ExternalBodyLength int32                  `protobuf:"varint,3,opt,name=external_body_length,json=externalBodyLength,proto3" json:"external_body_length,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *GreetResponse) GetExternalBodyLength() int32 {
	if x != nil {
